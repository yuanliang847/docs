...
-	[`3.7.0b4-stretch`, `3.7-rc-stretch`, `rc-stretch` (*3.7-rc/stretch/Dockerfile*)](https://github.com/docker-library/python/blob/ba5711fb564133bf9c8b870b431682a4db427219/3.7-rc/stretch/Dockerfile)
-	[`3.7.0b4-slim-stretch`, `3.7-rc-slim-stretch`, `rc-slim-stretch`, `3.7.0b4-slim`, `3.7-rc-slim`, `rc-slim` (*3.7-rc/stretch/slim/Dockerfile*)](https://github.com/docker-library/python/blob/b8c94a31a98a535477200482a32c95192f85af5b/3.7-rc/stretch/slim/Dockerfile)
-	[`3.7.0b4-alpine3.7`, `3.7-rc-alpine3.7`, `rc-alpine3.7`, `3.7.0b4-alpine`, `3.7-rc-alpine`, `rc-alpine` (*3.7-rc/alpine3.7/Dockerfile*)](https://github.com/docker-library/python/blob/ba5711fb564133bf9c8b870b431682a4db427219/3.7-rc/alpine3.7/Dockerfile)
-	[`3.6.5-stretch`, `3.6-stretch`, `3-stretch`, `stretch` (*3.6/stretch/Dockerfile*)](https://github.com/docker-library/python/blob/b99b66406ebe728fb4da64548066ad0be6582e08/3.6/stretch/Dockerfile)
-	[`3.6.5-slim-stretch`, `3.6-slim-stretch`, `3-slim-stretch`, `slim-stretch`, `3.6.5-slim`, `3.6-slim`, `3-slim`, `slim` (*3.6/stretch/slim/Dockerfile*)](https://github.com/docker-library/python/blob/b8c94a31a98a535477200482a32c95192f85af5b/3.6/stretch/slim/Dockerfile)
-	[`3.6.5-jessie`, `3.6-jessie`, `3-jessie`, `jessie` (*3.6/jessie/Dockerfile*)](https://github.com/docker-library/python/blob/b99b66406ebe728fb4da64548066ad0be6582e08/3.6/jessie/Dockerfile)
-	[`3.6.5-slim-jessie`, `3.6-slim-jessie`, `3-slim-jessie`, `slim-jessie` (*3.6/jessie/slim/Dockerfile*)](https://github.com/docker-library/python/blob/b8c94a31a98a535477200482a32c95192f85af5b/3.6/jessie/slim/Dockerfile)
...
-	[`3.6.5-alpine3.7`, `3.6-alpine3.7`, `3-alpine3.7`, `alpine3.7`, `3.6.5-alpine`, `3.6-alpine`, `3-alpine`, `alpine` (*3.6/alpine3.7/Dockerfile*)](https://github.com/docker-library/python/blob/b99b66406ebe728fb4da64548066ad0be6582e08/3.6/alpine3.7/Dockerfile)
-	[`3.6.5-alpine3.6`, `3.6-alpine3.6`, `3-alpine3.6`, `alpine3.6` (*3.6/alpine3.6/Dockerfile*)](https://github.com/docker-library/python/blob/b99b66406ebe728fb4da64548066ad0be6582e08/3.6/alpine3.6/Dockerfile)
...
-	[`3.5.5-alpine3.7`, `3.5-alpine3.7`, `3.5.5-alpine`, `3.5-alpine` (*3.5/alpine3.7/Dockerfile*)](https://github.com/docker-library/python/blob/a8eaaf400780f2b92422829a01cbd6368eed32ee/3.5/alpine3.7/Dockerfile)
...
-	[`3.4.8-alpine3.7`, `3.4-alpine3.7`, `3.4.8-alpine`, `3.4-alpine` (*3.4/alpine3.7/Dockerfile*)](https://github.com/docker-library/python/blob/a8eaaf400780f2b92422829a01cbd6368eed32ee/3.4/alpine3.7/Dockerfile)
...
-	[`2.7.15-alpine3.7`, `2.7-alpine3.7`, `2-alpine3.7`, `2.7.15-alpine`, `2.7-alpine`, `2-alpine` (*2.7/alpine3.7/Dockerfile*)](https://github.com/docker-library/python/blob/4d640edc8df64b9cf050904f60ac03765e05d3f6/2.7/alpine3.7/Dockerfile)
-	[`2.7.15-alpine3.6`, `2.7-alpine3.6`, `2-alpine3.6` (*2.7/alpine3.6/Dockerfile*)](https://github.com/docker-library/python/blob/4d640edc8df64b9cf050904f60ac03765e05d3f6/2.7/alpine3.6/Dockerfile)

## Shared Tags

-	`3.7.0b4`, `3.7-rc`, `rc`:
	-	[`3.7.0b4-stretch` (*3.7-rc/stretch/Dockerfile*)](https://github.com/docker-library/python/blob/ba5711fb564133bf9c8b870b431682a4db427219/3.7-rc/stretch/Dockerfile)
-	`3.7.0b4-windowsservercore`, `3.7-rc-windowsservercore`, `rc-windowsservercore`:
-	`3.6.5`, `3.6`, `3`, `latest`:
	-	[`3.6.5-stretch` (*3.6/stretch/Dockerfile*)](https://github.com/docker-library/python/blob/b99b66406ebe728fb4da64548066ad0be6582e08/3.6/stretch/Dockerfile)
...
## `ppc64le/python:onbuild`

The `ONBUILD` image variants are deprecated, and their usage is discouraged. For more details, see [docker-library/official-images#2076](https://github.com/docker-library/official-images/issues/2076).

This image feeds your `requirements.txt` file automatically to `pip` in order to make building derivative images easier. For most use cases, creating a `Dockerfile` in the base of your project directory with the line `FROM ppc64le/python:onbuild` will be enough to create a stand-alone image for your project.
