...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/piwik/badge/icon) (`arm32v5/piwik` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/piwik/)
...
```console
$ docker run --name some-piwik --link some-mysql:db -d arm32v5/piwik
```
