...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/piwik/badge/icon) (`ppc64le/piwik` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/piwik/)
...
```console
$ docker run --name some-piwik --link some-mysql:db -d ppc64le/piwik
```
