...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/redmine/badge/icon) (`arm64v8/redmine` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/redmine/)
...
2.	start redmine
	...
	```console
	$ docker run -d --name some-redmine --link some-postgres:postgres arm64v8/redmine
	```
