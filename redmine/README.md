...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/redmine/badge/icon) (`i386/redmine` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/redmine/)
...
2.	start redmine
	...
	```console
	$ docker run -d --name some-redmine --link some-postgres:postgres i386/redmine
	```
