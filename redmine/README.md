...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v7/job/redmine/badge/icon) (`arm32v7/redmine` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v7/job/redmine/)
...
2.	start redmine
	...
	```console
	$ docker run -d --name some-redmine --link some-postgres:postgres arm32v7/redmine
	```
