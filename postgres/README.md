...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v7/job/postgres/badge/icon) (`arm32v7/postgres` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v7/job/postgres/)
...
```console
$ docker run -it --rm --link some-postgres:postgres arm32v7/postgres psql -h postgres -U postgres
psql (9.5.0)
Type "help" for help.
