...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/postgres/badge/icon) (`arm32v5/postgres` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/postgres/)
...
```console
$ docker run -it --rm --link some-postgres:postgres arm32v5/postgres psql -h postgres -U postgres
psql (9.5.0)
Type "help" for help.
