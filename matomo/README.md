...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/matomo/badge/icon) (`i386/matomo` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/matomo/)
