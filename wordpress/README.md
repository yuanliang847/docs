...
```console
$ docker run --name some-wordpress --link some-mysql:mysql -d arm32v6/wordpress
```
...
```console
$ docker run --name some-wordpress --link some-mysql:mysql -p 8080:80 -d arm32v6/wordpress
```
