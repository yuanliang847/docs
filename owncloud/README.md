...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/owncloud/badge/icon) (`arm32v5/owncloud` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/owncloud/)
...
```console
$ docker run -d -p 80:80 arm32v5/owncloud:8.1
```
