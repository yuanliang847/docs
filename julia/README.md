...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/julia/badge/icon) (`ppc64le/julia` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/julia/)
